...
/**
 * @author Kevin
 * @date 2018-05-10 17:43.
 * @desc 通过SynchronousQueue队列保证只有一个线程在获取外部进程的退出码，由线程池提供超时功能。
...
public class LocalCommandExecutorImpl implements LocalCommandExecutor {
    ...
    @Override
    public ExecResult executeCommand(String command, long timeout) {
